...
format:
  html:
    ...
    include-in-header: 
      text: <meta http-equiv="Refresh" content="0; url='https://moonpiedumplings.github.io/projects/compiling-kasmvnc-on-nixos'" />
---
...
Here is first attempt for this.
...
I'm going to write further elaboration, but I need to finish by quarto via nix post, as that provides a lot of explanations as to how I got here.